...
## Summary
This project was born out of my dream of being able to build a complete Commodore 16 computer from scratch. While you can already build <a href="https://github.com/SukkoPera/LittleSixteen">the full circuit board</a> from off-the-shelf-components only (almost...) and put that in a case <a href="https://icomp.de/shop-icomp/en/shop/product/c64c-case.html">you can buy new on the market</a>, you would then have to complete that by stealing a keyboard from an original machine (and no, VIC-20/C64 keyboards won't work and there isn't much we can do in that regard, unless we patch the KERNAL and a ton of software). So I just set to rectify that.
